// string: 0-index, range: 1-index
// palinOdd[i]: length of odd palindrome from center i
// range: i - palinOdd[i] + 2, i + palinOdd[i]
// palinEven[i]: length of even palindrome from center i
// range: i - palinEven[i] + 1, i + palinEven[i]
